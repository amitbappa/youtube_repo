...
public class MainActivity   extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener, SocketEventListener, View.OnClickListener {
    ...
    private SocketEventEmitter socketEventEmitter;
    ...
    private void initVideoPlayer()
    {
       runOnUiThread (new Thread(new Runnable() {
            public void run() {
                youTubeView.initialize(mYTApiKey, MainActivity.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == RECOVERY_REQUEST) {
            ...
            getYouTubePlayerProvider().initialize(mYTApiKey, this);
        }
    }
    ...
    @Override
    public void onStartVideo(String url) {
        mVideoUrl=url;
    ...
    @Override
    public void onInitializeYTVideoPlayer(String apiKey) {
        mYTApiKey=apiKey;
        initVideoPlayer();
    }
    ...
    private final class MyPlaybackEventListener implements YouTubePlayer.PlaybackEventListener {
        ...
        public void onBuffering(boolean b) {
            ...
            showMessage("Is Buffering: "+ (b?"Yes":"False"));
